            ...
            {(orderDetails || checkout) && (
                <>
                    ...
                    <div className="p-6 rounded-lg border">
                        ...
                        {/* Ordered Items */}
                        <div className="mb-20">
                            {(Array.isArray(orderDetails?.orderItems) ? orderDetails.orderItems : Array.isArray(checkout?.checkoutItems) ? checkout.checkoutItems : []).map((item) => (
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">{(orderDetails && orderDetails.shippingAddress?.address) || (checkout && checkout.shippingAddress?.address)}</p>
                                <p className="text-gray-600">
                                    {(orderDetails && orderDetails.shippingAddress?.city) || (checkout && checkout.shippingAddress?.city)}
